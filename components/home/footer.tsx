      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-base mb-4 leading-relaxed hover:text-gray-300 transition-colors duration-300 font-bold">
          ...
          <div>
            ...
            <div className="space-y-1 text-gray-400 text-sm">
              ...
              <p className="text-sm hover:text-white transition-colors duration-300 font-bold">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">
              <p className="text-white font-bold mb-1">OPEN HOURS</p>
              <p className="hover:text-white transition-colors duration-300 font-bold">
                Monday - Sunday
              </p>
            </div>
          </div>
          ...
          {/* Order Us */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-white">ORDER US</h4>
            <div className="space-y-2 text-gray-400 text-sm">
              <div className="flex items-center hover:text-white transition-colors duration-300 cursor-pointer font-bold">
