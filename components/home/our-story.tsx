        ...
        <div className="flex items-center justify-center p-6 md:p-12 relative">
          ...
          <div className="space-y-6 md:space-y-8 max-w-lg relative z-10">
            <div className="relative">
              ...
              <h2 className="chanoly-heading text-3xl sm:text-4xl md:text-6xl text-white tracking-widest mb-6 md:mb-8 hover:text-chanoly transition-colors duration-500 font-bold drop-shadow-lg">
                OUR STORY
              </h2>
            </div>
