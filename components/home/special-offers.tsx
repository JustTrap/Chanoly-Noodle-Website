      ...
      <div className="grid grid-cols-[400px_1fr] gap-16 max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <h3 className="text-3xl md:text-4xl font-semibold font-showg">Coming Soon</h3>
          </div>

                      {/* Description */}
            <div className="space-y-6">
              <p className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-tight opacity-95 max-w-lg font-showg">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 border border-white/20">
            <h4 className="text-xl font-semibold mb-3 font-showg">Loyalty Program</h4>
          ...
          <div className="pt-4">
            <p className="text-sm text-white/70 italic mb-6">
              Join our community and be the first to know about exclusive offers
            </p>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-12 h-12 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm border border-white/30 hover:scale-110"
              >
